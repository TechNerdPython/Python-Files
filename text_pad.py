...
def open_file():
    ...
    # Grab Filename
    text_file = filedialog.askopenfilename(initialdir="C:/Users/splba/Python", title="Open File", filetypes=(
    ...
    name = name.replace("C:/Users/splba/Python/", "")
...
# Save As File
def save_as_file():
    text_file = filedialog.asksaveasfilename(defaultextension=".*", initialdir="C:/Users/splba/Python", title="Save File", filetypes=(("Text Files", "*.txt"), ("HTML Files", "*.html"), ("Python Files", "*.py"), ("All Files", "*.*")))
    if text_file:
        # Update Status Bars
        name = text_file
...
def print_file():
    ...
    # Grab a Filename
    file_to_print = filedialog.askopenfilename(initialdir="C:/Users/splba/Python", title="Open File", filetypes=(
        ("Text Files", "*.txt"), ("HTML Files", "*.html"), ("Python Files", "*.py"), ("All Files", "*.*")))
...
# Add Status Bar to Bottom of the App
