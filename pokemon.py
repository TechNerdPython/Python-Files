...
class Pokemon:
    ...
    def fight(self, Pokemon2):
        ...
        while (self.bars > 0) and (Pokemon2.bars > 0):
            ...
            if Pokemon2.bars <= 0:
                delay_print("\n..." + Pokemon2.name + ' is unable to battle!.')
                break
...
if __name__ == "__main__":
    # Create Pokemon
    Charizard = Pokemon("Charizard", "Fire", ["Flamthrower", "Dragon Claw", "Blast Burn", "Thunder Punch"], {"ATTACK": 12, "DEFENSE": 8})
    ...
    Charizard.fight(Venusaur) # Get them to fight